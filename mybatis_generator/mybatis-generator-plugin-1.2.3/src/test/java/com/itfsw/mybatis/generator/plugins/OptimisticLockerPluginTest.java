	...
	public void testDeleteWithVersionByPrimaryKey() throws Exception {
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// sql
				String sql = SqlHelper.getFormatMapperSql(tbMapper.getObject(), "deleteWithVersionByPrimaryKey", 100L,
						1L);
				Assert.assertEquals(sql, "delete from tb where inc_f1 = 100 and id = 1");
	...
	public void testUpdateWithVersionByExampleSelective() throws Exception {
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// sql
				String sql = SqlHelper.getFormatMapperSql(tbMapper.getObject(), "updateWithVersionByExampleSelective",
						100L, tb.getObject(), tbExample.getObject());
	...
	public void testUpdateWithVersionByExampleWithBLOBs() throws Exception {
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// sql
				String sql = SqlHelper.getFormatMapperSql(tbBlobsMapper.getObject(), "updateWithVersionByExample", 100L,
						tbBlobs.getObject(), tbBlobsExample.getObject());
				Assert.assertEquals(sql,
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// id = 1 的版本号应该是1
				result = tbBlobsMapper.invoke("updateWithVersionByExampleWithBLOBs", 1L, tbBlobsWithBLOBs.getObject(),
						tbBlobsExample.getObject());
				Assert.assertEquals(result, 1);
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// 执行一次，因为版本号100不存在所以应该返回0
				Object result = tbBlobsMapper.invoke("updateWithVersionByExample", 100L, tbBlobsBuilder.invoke("build"),
						tbBlobsExample.getObject());
				Assert.assertEquals(result, 0);
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// id = 1 的版本号应该是1
				result = tbBlobsMapper.invoke("updateWithVersionByExampleWithBLOBs", 1L, tbBlobsBuilder.invoke("build"),
						tbBlobsExample.getObject());
				Assert.assertEquals(result, 1);
	...
	public void testUpdateWithVersionByPrimaryKey() throws Exception {
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// sql
				String sql = SqlHelper.getFormatMapperSql(tbMapper.getObject(), "updateWithVersionByPrimaryKey", 100L,
						tb.getObject());
				Assert.assertEquals(sql,
	...
	public void testUpdateWithVersionByPrimaryKeyWithBLOBs() throws Exception {
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// sql
				String sql = SqlHelper.getFormatMapperSql(tbBlobsMapper.getObject(), "updateWithVersionByPrimaryKey",
						100L, tbBlobs.getObject());
				Assert.assertEquals(sql,
	...
	public void testWithIncrementsPlugin() throws Exception {
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// sql
				String sql = SqlHelper.getFormatMapperSql(tbMapper.getObject(), "updateWithVersionByExampleSelective",
						100L, tbBuilder.invoke("build"), tbExample.getObject());
				Assert.assertEquals(sql,
						"update tb SET inc_f1 = inc_f1 + 1, id = 1, inc_f2 = inc_f2 + 5 , inc_f3 = 10 WHERE inc_f1 = 100 and ( ( id = '1' ) )");

				// 执行一次，因为版本号100不存在所以应该返回0
				Object result = tbMapper.invoke("updateWithVersionByExampleSelective", 100L, tbBuilder.invoke("build"),
						tbExample.getObject());
				Assert.assertEquals(result, 0);
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// id = 1 的版本号应该是1
				result = tbBlobsMapper.invoke("updateWithVersionByExample", 1L, tbBlobsWithBLOBsBuilder.invoke("build"),
						tbBlobsExample.getObject());
				Assert.assertEquals(result, 1);
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				// sql
				String sql = SqlHelper.getFormatMapperSql(tbBlobsMapper.getObject(), "updateWithVersionByPrimaryKey",
						100L, tbBlobsWithBLOBsBuilder.invoke("build"));
				Assert.assertEquals(sql,
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				Assert.assertEquals(sql,
						"update tb SET inc_f1 = inc_f1 + 1, id = 1, inc_f2 = 10, inc_f3 = 5 WHERE inc_f1 = 100 and ( ( id = '1' ) )");
				// sql(selective增强)
				sql = SqlHelper.getFormatMapperSql(tbMapper.getObject(), "updateWithVersionByExampleSelective", 100L,
		...
		tool.generate(new IBeforeCallback() {
			...
			public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
				...
				Assert.assertEquals(sql,
						"update tb SET inc_f1 = inc_f1 + 1, inc_f2 = 10, inc_f3 = 5 where inc_f1 = 100 and id = 1");
				// sql(selective增强)
				sql = SqlHelper.getFormatMapperSql(tbMapper.getObject(), "updateWithVersionByPrimaryKeySelective", 100L,
