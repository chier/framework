    ...
    public void testModelBuilderMethod() throws Exception {
        ...
        tool.generate(new IBeforeCallback(){
            ...
            public void reloadProject(SqlSession sqlSession, ClassLoader loader, String packagz) throws Exception {
                ...
                // TODO JDK8
//                Assert.assertEquals(incMethod.getParameters()[1].getParameterizedType().getName(), packagz + ".Tb$Builder$Inc");
                // TODO JDK7                
                Assert.assertEquals(incMethod.getTypeParameters()[1].getName(), packagz + ".Tb$Builder$Inc");
